...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark"
     style="background:rgba(0,0,0,0.19); padding:13px 0; transition:all 0.3s; z-index:9999;">
  <div class="container">
    <a class="navbar-brand fw-bold" href="/Tiket_wisata_labuanbajo/users/halaman/index.php" style="font-size:22px;">LabuanBajoTrip</a>
