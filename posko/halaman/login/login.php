...
<!-- ✅ Background gambar dipasang inline -->
<body class="bg-light d-flex align-items-center justify-content-center vh-100" 
style="background: url('../../../assets/bg-posko.jpg') no-repeat center center fixed; 
background-size: cover;">

<div class="container">
  <div class="card mx-auto shadow-lg border-0 bg-white bg-opacity-75 backdrop-blur" style="max-width: 420px;">
