...
--
-- Host: localhost:3306
-- Generation Time: Nov 08, 2025 at 04:09 AM
...
-- Database: `labuanbajo`
--
CREATE DATABASE IF NOT EXISTS `labuanbajo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `labuanbajo`;
...
CREATE TABLE IF NOT EXISTS `galleries` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_galleries_kategori` (`kategori_id`)
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  PRIMARY KEY (`id`),
  KEY `payments_fk_transaction` (`transaction_id`),
  KEY `payments_fk_pemesanan` (`pemesanan_id`)
...
CREATE TABLE IF NOT EXISTS `pemesanan` (
  ...
  PRIMARY KEY (`id`),
  KEY `pemesanan_fk_user` (`user_id`),
  KEY `pemesanan_fk_tiket` (`tiket_id`),
...
CREATE TABLE IF NOT EXISTS `tiket` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_tiket_kategori` (`kategori_id`),
  KEY `idx_lokasi` (`lokasi`),
  KEY `fk_tiket_tipe_trip` (`tipe_trip_id`)
...
DROP TABLE IF EXISTS `tiket_terjual_harian`;
CREATE TABLE IF NOT EXISTS `tiket_terjual_harian` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tiket_id` int NOT NULL,
  `tanggal_kunjungan` date NOT NULL,
  ...
  KEY `idx_tiket_tanggal` (`tiket_id`,`tanggal_kunjungan`)
...
DROP TABLE IF EXISTS `tipe_trip`;
CREATE TABLE IF NOT EXISTS `tipe_trip` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `transactions` (
  ...
  PRIMARY KEY (`id`),
  KEY `transactions_fk_user` (`user_id`),
  KEY `transactions_fk_tiket` (`ticket_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
DROP TABLE IF EXISTS `verifikasi_history`;
...
-- Events
--
DROP EVENT IF EXISTS `reset_stok_harian`$$
