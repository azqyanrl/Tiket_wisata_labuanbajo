...
<body style="background: url('../image/padarhd.avif') no-repeat center center fixed; background-size: cover; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; min-height: 100vh;">
<div class="container" style="max-width: 500px; margin: 100px auto;">
    <div style="background: rgba(255, 255, 255, 0.15); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); border-radius: 20px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3); border: 1px solid rgba(255, 255, 255, 0.18); padding: 30px;">
        ...
        <form action="register.php" method="post">
            ...
            <div style="margin-bottom: 15px;">
                <label style="font-weight: 600; color: #fff; margin-bottom: 5px; display: block;">Password</label>
                <div style="display: flex; align-items: center;">
                    <span style="background: rgba(255, 255, 255, 0.2); border: none; color: #fff; padding: 10px 15px; border-radius: 10px 0 0 10px;"><i class="fas fa-lock"></i></span>
                    <input type="password" name="password" class="form-control" placeholder="Minimal 6 karakter" required 
                           style="background: rgba(255, 255, 255, 0.7); border: none; border-radius: 0 10px 10px 0; padding: 12px 15px; width: 100%;">
                </div>
                <small style="color: rgba(255, 255, 255, 0.7); font-size: 0.85rem;">Gunakan kombinasi huruf dan angka untuk keamanan</small>
            </div>
