    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item"><a class="nav-link <?php echo ($page == 'laporan_stok') ? 'active' : ''; ?>" href="?page=laporan_stok"><i class="bi bi-file-earmark-bar-graph me-2"></i> Laporan Stok</a></li>
