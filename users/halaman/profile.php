            ...
            <div class="tab-pane fade" id="riwayat" role="tabpanel">
              ...
              <?php if (empty($pemesanan)): ?>
                <div class="alert alert-info" role="alert">
                  ...
                  Anda belum memiliki pemesanan tiket. <a href="destinasi.php" class="alert-link">Lihat paket wisata</a> untuk memesan tiket.
                </div>
              <?php else: ?>
                <div class="row g-4">
                        ...
                        <div class="card-body">
                          <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <span class="badge status-badge bg-<?=
                                                                $booking['status'] == 'dibayar' ? 'success' : ($booking['status'] == 'pending' ? 'warning' : ($booking['status'] == 'selesai' ? 'info' : 'danger'))
                                                                ?>">
